    ...
    return (
      <View style={styles.inputcontainer}>
        ...
        <View style={styles.genderButtonsContainer}>
          <TouchableOpacity style={(this.state.gender === 'male') ? styles.activebutton : styles.inactivebutton}
          ...
          <TouchableOpacity style={(this.state.gender === 'female') ? styles.activebuttonpink : styles.inactivebutton}
        ...
        <View style={styles.buttoncontainer}>
          <Button title="Save" onPress={this._saveChangesAsync} color="rgb(28, 184, 65)"
